    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (error.message === "device_used") {
                ...
                errorMessage.textContent = "❌ Không có quyền truy cập dữ liệu. Kiểm tra lại Firestore Security Rules.";
            } else {
...
onAuthStateChanged(auth, (user) => {
    if (user) {
        ...
        // BUG ĐÃ SỬA: "includes" bị dán lỗi thành "inc\n ludes" -> SyntaxError,
        // khiến toàn bộ file auth.js không chạy được, nên hideLoader() không
        // bao giờ được gọi -> vòng tròn loading xoay mãi mãi.
